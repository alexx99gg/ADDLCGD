...
plink --bfile "merged/${file}" --make-bed --missing-genotype N --chr 1-22 --rel-cutoff 0.025 --out "cleaned/${file}"
...
# Apply LD-clumping
plink --bfile "subsets/${file}_1" --clump "subsets/${file}_1.assoc.fisher.perm" --clump-field EMP1 --clump-best --clump-p1 0.000005 --clump-r2 0.5 --out "subsets/${file}_1"
